...
window.addEventListener("DOMContentLoaded", (event) => {
  ...
  const displayTodo = () => {
    ...
    taskArray.forEach((task, index) => {
      ...
      taskInfo.innerHTML = `<strong style= color:blue;>${task.nameOfTask}</strong>: ${task.taskDescription}`;
...
//     const editTodo = (index) => {
//       const updatedName = prompt("Enter the updated task name:", taskArray[index].nameOfTask);
//       const updatedDescription = prompt("Enter the updated description:", taskArray[index].taskDescription);
